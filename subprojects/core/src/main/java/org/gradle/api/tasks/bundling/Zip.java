...
public class Zip extends AbstractArchiveTask {
    ...
    protected CopyAction createCopyAction() {
        ...
        return new ZipCopyAction(getArchiveFile().get().getAsFile(), getCompressor(), documentationRegistry, metadataCharset, isPreserveFileTimestamps(), getTimeForArchiveEntries());
    }
